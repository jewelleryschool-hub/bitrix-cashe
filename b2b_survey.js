...
const PROGRAM_BLOCKS = [
  ['Основы конструкции и подготовка', [
    ...
    'допуски и посадочные места под закрепку',
...
const SCHEMA = [
  ...
  },
  {
    ...
    q: [
      ...
      { id: 'q10', n: 10, t: 'text', label: 'Численность производственного персонала: всего и из них монтировщиков' }
    ]
  },
  {
    ...
    q: [
      { id: 'q17', n: 17, t: 'one', label: 'Доля изделий, которые возвращаются на доработку после монтировки', o: ['менее 3%', '3-7%', '7-15%', 'более 15%', 'не считаем'], req: true },
      {
        id: 'q18', n: 18, t: 'multi', label: 'Основные причины возвратов и брака на монтировке (до трёх главных)', max: 3, o: [
          ...
          'посадочное место под камень не соответствует размеру',
  ...
  },
  {
    ...
    q: [
      { id: 'q32', n: 32, t: 'one', label: 'Предпочтительный формат', o: ['обучение на площадке школы в Санкт-Петербурге', 'выезд преподавателя на ваше производство', 'смешанный: база в школе, отработка на месте', 'онлайн-теория плюс очная практика'], req: true },
      { id: 'q33', n: 33, t: 'one', label: 'Если выездной формат: сможете предоставить оборудованные рабочие места нужного уровня', o: ['да, полностью', 'частично', 'нет'] },
      { id: 'q34', n: 34, t: 'one', label: 'Комфортная длительность', o: ['5 дней', '10 рабочих дней', '15 рабочих дней', 'модулями по нескольку дней с перерывами'] },
  ...
  },
  {
    ...
    q: [
      { id: 'q39', n: 39, t: 'one', label: 'Обоснованный бюджет на обучение одного монтировщика при измеримом снижении брака', o: ['до 100 тыс. руб.', '100-200 тыс.', '200-350 тыс.', 'свыше 350 тыс.', 'зависит от результата, готовы обсуждать'], req: true },
      { id: 'q40', n: 40, t: 'text', label: 'Выездной формат на вашей площадке: обоснованный бюджет на группу до 5 человек' },
      { id: 'q41', n: 41, t: 'one', label: 'Кто принимает решение о таком обучении', o: ['вы', 'собственник', 'финансовый директор', 'коллегиально'] },
      {
        id: 'q42', n: 42, t: 'multi', max: 3, label: 'Что должно быть в предложении для положительного решения (до трёх)', o: [
          ...
          'возможность прислать сначала одного человека как пилот'
        ]
      },
  ...
  },
  {
    ...
    q: [
      ...
      { id: 'q46', n: 46, t: 'area', label: 'С какими предприятиями вашего уровня стоит поговорить на эту тему' }
    ]
  }
];
